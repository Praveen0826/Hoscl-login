...
// const PinSection = () => {
//   const [oldPin, setOldPin] = useState(new Array(6).fill(""));
...
//      <h1 className="ml-3 text-sm font-semibold mt-2">Old Pin</h1>
//       <PinInput  pin={oldPin} setPin={setOldPin} />
//       <h1 className="ml-3 text-sm font-semibold">New Pin</h1>
//       <PinInput  pin={newPin} setPin={setNewPin} />
//       <h1 className="ml-3 text-sm font-semibold">New Confirm Pin</h1>
...
const PinSection = () => {
  ...
  const handleSubmit = () => {
    ...
    if (oldPin.some((digit) => digit === "")) {
      setError("Old PIN is incomplete.");
      return;
    }
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow">
      ...
      <PinInput label="Old PIN" pin={oldPin} setPin={setOldPin} />
      <PinInput label="New PIN" pin={newPin} setPin={setNewPin} />
      <PinInput label="Confirm PIN" pin={confirmPin} setPin={setConfirmPin} />
